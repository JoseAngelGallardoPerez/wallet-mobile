...
class UserRepository {
  ...
  Stream<Resource<void, String>> signUp({
    ...
    final networkClient = NetworkBoundResource<void, CredentialsData, String>(
        _apiParser, saveCallResult: (item) async {
      try {
        await _sessionRepository.initSession(
          accessToken: item.accessToken,
          refreshToken: item.refreshToken,
      ...
      return _apiProvider.signUp(
          email, password, confirmPassword, phoneNumber, profileType);
    }, loadFromCache: () {
      return null;
    }, shouldFetch: (data) {
      return true;
  ...
  Stream<Resource<UserData, String>> getUserData() {
    final networkClient = NetworkBoundResource<UserData, UserData, String>(
        _apiParser, saveCallResult: (UserData item) async {
  ...
  Stream<Resource<void, String>> updateUserData(
    ...
    final networkClient = NetworkBoundResource<void, void, String>(_apiParser,
      ...
      _sessionRepository.updateUserData(
          firstName: firstName, lastName: lastName, nickname: nickName);
      return item;
    }, createCall: () {
      return _apiProvider.updateUserData(
          firstName: firstName,
          lastName: lastName,
          nickName: nickName);
    }, loadFromCache: () {
  ...
  Stream<Resource<void, String>> createNewPassword(
  ...
  Stream<Resource<void, String>> resetPassword(
    ...
    final networkClient = NetworkBoundResource<void, void, String>(_apiParser,
        ...
        createCall: () => _apiProvider.resetPassword(
            previousPassword, proposedPassword, confirmPassword),
        loadFromCache: () => null,
