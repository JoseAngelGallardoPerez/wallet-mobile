...
class Button extends StatelessWidget {
  Button({
    ...
    shadowColor = this.shadowColor ?? Get.theme.colorScheme.primaryVariant.withOpacity(0.5);
    ...
    return BlocBuilder<LoaderBloc, LoaderState>(
      ...
      builder: (context, state) => Container(
        ...
        child: MaterialButton(
          ...
          disabledColor: Get.theme.colorScheme.primaryExtraLight,
