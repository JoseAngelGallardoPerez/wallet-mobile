                    ...
                    children: <Widget>[
                      GestureDetector(
                        ...
                        child: ListTile(
                          ...
                          title: Text(
                              '${widget.initialSelection.name}  ${widget.initialSelection.dialCode}',
                              textAlign: TextAlign.start,
                              style: theme.textStyles.r16
                                  .copyWith(color: theme.colors.darkShade)),
      ...
      child: (country == widget.initialSelection)
          ...
          : Column(
              children: <Widget>[
                ...
                Divider(
                    thickness: 1, height: 1, color: theme.colors.lightShade),
              ],
            ),
    );
  }
